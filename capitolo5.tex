...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.55\textwidth]{./figures/bqp_graph.png}
...
Abbiamo capito quindi i diversi livelli di difficoltà dei problemi matematici, ora possiamo entrare nel vivo della relazione e analizzare le famiglie di algoritmi post-quantistici a partire dalle ppiù promettenti: i reticoli algebrici.
